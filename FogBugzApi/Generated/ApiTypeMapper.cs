...
{
    public static readonly string QueryColumns = "ixBug,ixStatus,sTitle,sStatus,ixPersonResolvedBy,hrsOrigEst,hrsCurrEst,hrsElapsed,fOpen,dtOpened,dtResolved,dtClosed";
}
...
public class FogBugzPersonApiObj
{
        ...
        public string dtLastActivity { get; set; }
    ...
    public static void InitMappings()
    {
        AutoMapper.Mapper.CreateMap<FogBugzCaseApiObj, FogBugzCase>()
            .ForMember(d => d.CaseId, o => o.MapFrom(s => s.ixBug))
                ...
                .ForMember(d => d.DateOpened, o => o.MapFrom(s => string.IsNullOrEmpty(s.dtOpened) ? null : s.dtOpened ))    
                .ForMember(d => d.DateResolved, o => o.MapFrom(s => string.IsNullOrEmpty(s.dtResolved) ? null : s.dtResolved ))    
                .ForMember(d => d.DateClosed, o => o.MapFrom(s => string.IsNullOrEmpty(s.dtClosed) ? null : s.dtClosed ))    
            ;
        AutoMapper.Mapper.CreateMap<FogBugzIntervalApiObj, FogBugzInterval>()
            .ForMember(d => d.CaseId, o => o.MapFrom(s => s.ixBug))
                .ForMember(d => d.IntervalId, o => o.MapFrom(s => s.ixInterval))
                .ForMember(d => d.Start, o => o.MapFrom(s => string.IsNullOrEmpty(s.dtStart) ? null : s.dtStart ))    
                .ForMember(d => d.End, o => o.MapFrom(s => string.IsNullOrEmpty(s.dtEnd) ? null : s.dtEnd ))    
        ...
        AutoMapper.Mapper.CreateMap<FogBugzPersonApiObj, FogBugzPerson>()
            .ForMember(d => d.PersonId, o => o.MapFrom(s => s.ixPerson))
                ...
                .ForMember(d => d.LastActivity, o => o.MapFrom(s => string.IsNullOrEmpty(s.dtLastActivity) ? null : s.dtLastActivity ))    
